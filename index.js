...
program
  ...
  .option('-f, --file <path>', 'Path to the JSON file containing goals')
  .parse(process.argv);
      ...
      parsedData.forEach(item => {
        test(item.goal, async ({
          ...
          const prompt = ChatPromptTemplate.fromMessages([
            ["system", "You are a tester, navigate the website using screen reader try your best to understand the website and finish the given task"],
